...
public abstract class AbstractWebmentionEndpointServlet extends HttpServlet {
	...
	private AbstractWebmentionEndpointServlet(@NonNull Supplier<CloseableHttpClient> httpClientFactory,
	 ...
	 */
	protected abstract void handleWebmention(@NonNull Webmention webmention);
